...
public class VIPIN extends JFrame {

	

	static ArrayList<String> VIP = new ArrayList<String>();
		...
		btnCheckIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					for(int i=0 ; i<SignUp.getVip().size();i++)
				{
					...
					{
						display=true;
						JOptionPane.showMessageDialog(null, "Mr. "+ SignUp.getVip().get(i).getName()  +" : Logged In");
						
						VIP.add(textField.getText());
